            ...
            <div class="col-xs-12">
                ...
                <form role="form" class="form-inline" id="form_creacion_jugador" name="form_creacion_jugador" runat="server">
                    ...
                    <div class="col-lg-12">
                        ...
                        <asp:ValidationSummary ID="ValidationSummaryEditJugador" runat="server" ShowMessageBox="True" ShowSummary="False" ValidationGroup="EditJugador" />
                        <asp:ValidationSummary ID="ValidationSummaryInsertJugador" runat="server" ShowMessageBox="True" ShowSummary="False" ValidationGroup="InsertJugador" />
                    </div>
                </form>
            </div>
        </div>
