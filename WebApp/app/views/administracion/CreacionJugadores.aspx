                ...
                <form role="form" class="form-horizontal" id="form_creacion_jugador" runat="server">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator class="alert-text" SetFocusOnError="True" runat="server" ControlToValidate="txtbox_nombre_jugador" ErrorMessage="Nombre del jugador es requerido"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator class="alert-text" SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtbox_apellido_jugador" ErrorMessage="Apellido del jugador es requerido"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RegularExpressionValidator class="alert-text" SetFocusOnError="True" runat="server" ControlToValidate="txtbox_edad" ErrorMessage="El campo de edad solo puede contener numeros" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator runat="server" class="alert-text" SetFocusOnError="True" ControlToValidate="dropdown_equipo" ErrorMessage="El campo es requerido"></asp:RequiredFieldValidator>
