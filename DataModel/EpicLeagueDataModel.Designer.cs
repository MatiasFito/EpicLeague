...
namespace DataModel
{
    ...
    /// </summary>
    public partial class EpicLeagueEntities : ObjectContext
    {
        #region Constructores
    
        /// <summary>
        /// Inicializa un nuevo objeto EpicLeagueEntities usando la cadena de conexión encontrada en la sección 'EpicLeagueEntities' del archivo de configuración de la aplicación.
        /// </summary>
        public EpicLeagueEntities() : base("name=EpicLeagueEntities", "EpicLeagueEntities")
        {
        ...
        /// <summary>
        /// Inicializar un nuevo objeto EpicLeagueEntities.
        /// </summary>
        public EpicLeagueEntities(string connectionString) : base(connectionString, "EpicLeagueEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Inicializar un nuevo objeto EpicLeagueEntities.
        /// </summary>
        public EpicLeagueEntities(EntityConnection connection) : base(connection, "EpicLeagueEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
